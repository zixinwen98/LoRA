...
class RobertaSelfAttention(nn.Module):
    def __init__(self, config):
        ...
        if config.apply_lora:
            self.query = lora.Linear(config.hidden_size, self.all_head_size, config.lora_r, lora_alpha=config.lora_alpha, lora_dropout=config.lora_dropout, lora_norm=True)
        else:
        ...
        if config.apply_lora:
            self.value = lora.Linear(config.hidden_size, self.all_head_size, config.lora_r, lora_alpha=config.lora_alpha,lora_dropout=config.lora_dropout, lora_norm=True)
        else:
